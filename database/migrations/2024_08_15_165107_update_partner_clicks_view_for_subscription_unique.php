...
class UpdatePartnerClicksViewForSubscriptionUnique extends Migration
{
    public function up()
    {
        DB::statement("
            ...
            GROUP BY 
                p.zoho_cust_id, p.company_name, pu.email, pl.plan_code, s.addon, s.subscription_id, pl.max_clicks, ao.max_clicks, click_month, click_year
            ORDER BY 
