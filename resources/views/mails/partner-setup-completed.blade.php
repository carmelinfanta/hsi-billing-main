            ...
            <tr>
                <td>
                    <div
                        ...
                        <p
                            style="color: black; font-size: 16px; font-family: Verdana, sans-serif; font-weight: 400; text-align: left; line-height: 26px;">
                            <strong>Partner Setup Completed</strong>
                        </p>

                        <p
                            style="color: black; font-size: 16px; font-family: Verdana, sans-serif; font-weight: 400; text-align: left; line-height: 26px;">
                            The setup for {{ $partner_name }} has been completed<br />Here are the details:</p>
                        ...
                        <ul
                            ...
                            @if ($file_name)
                                <li>Partner AOA CSV File (Link Expires) : <a
                                        href="{{ $presigned_url }}">{{ $file_name }}</a></li>
                            @else
                            ...
                            <li>Advertiser ID: {{ $advertiser_id }}</li>

                            <li>Plan Subscribed : {{ $subscribed_plan }}</li>

                            <li>Payment Method Type : {{ $payment_method_type }}</li>

                            <li>Budget Cap : {{ isset($budget_cap) ? $budget_cap : 'Bugdet Cap Not Added' }}</li>
