...
@section('content')
        ...
        <div>
            <div class="row">
                <div class="col-md-6 border-0 border-end px-2">
                    <div class="">
                        ...
                        <ul class="billing">
                            ...
                            @if ($plan->is_cpc)
                                <li class="billing mb-1">With our CPC billing system, we don’t charge you upfront. At the
                                    start of the next month, we calculate your usage from the previous month by counting the
                                    clicks you’ve received and multiplying them by the base plan rate. This way, you only
                                    pay for what you’ve received.</li>
                            @else
                                <li class="billing mb-1">We've implemented calendar billing on the 1st of every month. If
                                    you subscribe after the 1st of the month, the first month will be prorated. Subsequent
                                    renewals will be charged for the full calendar month.</li>
                            @endif
                ...
                <div class="col-md-6 col-split ps-5 pe-2">
                    ...
                    <p><small>Next Renewal Date
                            {{ Carbon\Carbon::parse($subscription->next_billing_at)->format('d-M-Y') }}</small></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a data-bs-toggle="modal" data-bs-target="#termsModal{{ $plan->id }}"
    ...
    <div class="modal fade" id="termsModal{{ $plan->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content bg-popup ">
                ...
                <div class="modal-footer d-flex flex-row justify-content-end bg-popup">
                    ...
                    <a id="myLink" href="/subscribe-update/{{ $plan->plan_id }}"
