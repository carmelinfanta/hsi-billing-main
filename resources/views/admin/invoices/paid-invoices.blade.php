...
@section('child-content')
    <div class="d-flex flex-column w-100">
        ...
        <div class="top-row w-100">
            <div class="row">
                <div class="col-md-11">
                    <form action="{{ route('admin.invoice', [], false) }}" method="GET"
                                    ...
                                    <div class="modal-content text-white" style="background-color: #162b64;">
                                        ...
                                        <div class="modal-body">
                                            <form action="/record-payment" method="post">
                                                    ...
                                                    <div class="col-lg">
                                                        ...
                                                        @if (isset($invoice->invoice_items['name']))
                                                            <input type="text" name="amount" class="form-control"
                                                                value="{{ round($invoice->invoice_items['price'] - $invoice->credits_applied, 2) }}"
                                                                readonly required>
                                                        @else
                                                            @if (count($invoice->invoice_items) === 2)
                                                                <input type="text" name="amount" class="form-control"
                                                            ...
                                                            @else
                                                                <input type="text" name="amount" class="form-control"
                                                                    value="{{ round($invoice->invoice_items[0]['price'] - $invoice->credits_applied, 2) }}"
                                                                    readonly required>
                                                            @endif
                                                        @endif
                                                ...
                                                <button type="submit"
                                                    class="btn btn-danger text-white px-3 py-2 rounded">Save<i
