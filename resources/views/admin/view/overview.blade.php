...
@else
    ...
    @endif -->
                    ...
                    <div class="d-flex flex-row justify-content-between">
                        <div class="col-lg-10 ">
                            <p class="m-0"><i class="fa text-primary fa-building right-margin fw-bold"
                                    aria-hidden="true"></i> <strong>{{ $partner->company_name ?? '' }}</strong></p>

                        </div>

                        <div class="col-lg mt-2">
                            <a style="cursor:pointer;" class="text-primary" data-toggle="tooltip" title="Edit"
                                data-bs-toggle="modal" data-bs-target="#partnerUpdateModal"><i
                                    class="fa-regular fa-pen-to-square"></i></a>
                            @if ($partner->status === 'active')
                                <a href="disable-partner/{{ $partner->id }}" data-toggle="tooltip" title="Mark as Inactive"
                                    class="text-primary ms-3">

                                    <i class="fa-solid fa-user-slash"></i>
                                </a>
                            @else
                                <a href="reactivate-partner/{{ $partner->id }}" data-toggle="tooltip"
                                    title="Mark as Active" class="text-primary ms-3">
                    ...
                    <div class="right-margin mb-0 w-100">
                        <div class="row ">
                            <div class="d-flex flex-row col-lg">
                                <p class="fw-bold left-margin ">Advertiser Id:</p><span
                                    class="ms-2">{{ $partner->isp_advertiser_id }}</span>
                            </div>

                            <div class="d-flex flex-row col-lg">
                                @if ($partner->tax_number)
                                    <p class="fw-bold left-margin">EIN ID:</p><span
                                        class="ms-2">{{ $partner->tax_number }}</span>
                                @endif
                            </div>
                    ...
                    <div class="right-margin">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <div class="d-flex flex-row col-lg">
                                <p><a data-bs-toggle="modal" data-toggle="tooltip" title="Add Affiliate"
                                        data-bs-target="#addAffiliateModal" style="cursor:pointer;"
                                        class="text-dark fw-bold"><i
                                            class="fa-solid fa-circle-plus text-primary ms-3"></i></a></p>
                                @if ($subscription === null)
                                    <p><a data-bs-toggle="modal" data-toggle="tooltip" title="Remove Affiliate"
                                            data-bs-target="#removeAffiliateModal" style="cursor:pointer;"
                                            class="text-dark  fw-bold"><i
                                                class="fa-solid fa-circle-minus text-primary  ms-4"></i></a></p>
                                @endif
                            </div>
                        ...
                        <ul class="right-margin">
                            @foreach ($isp_affiliates as $isp_affiliate)
                                <li class="billing">
                                    {{ $isp_affiliate->isp_affiliate_id }}({{ $isp_affiliate->domain_name }})</li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="right-margin">
                        <div class="d-flex flex-row justify-content-between">
                            <div class="col-lg-10">
                                <p class="fw-bold left-margin ">Tune Links:</p>
                            </div>
                        </div>
                        @if ($tune_links)
                            <ul class="right-margin">
                                @foreach ($tune_links as $tune_link)
                                    <li class="billing">
                                        {{ $tune_link }}</li>
                                @endforeach
                            </ul>
                    ...
                    <div class="accordion accordion-flush border-0 shadow-none right-margin mb-0 " id="accordionExample">
                        <div class="accordion-item bg-clearlink">
                            <h2 class="accordion-header">
                                <button class="accordion-button p-0 fw-bold border-0 outline-0 border-bottom fw-bold"
                                ...
                                <div class="accordion-body p-0 pt-2 ">
                                    <div class="d-flex flex-row justify-content-between">
                                        <div class="d-flex flex-row ">
                                            <div class="m-0"><i class="fa fa-address-card  text-primary"
                                                    aria-hidden="true"></i></div>
                                            <div class="right-margin"><strong> Billing
                                                    Address</strong><br>{{ $partner_address->street ?? '' }}<br>{{ $partner_address->city ?? '' }},<br>{{ $partner_address->state ?? '' }},{{ $partner_address->zip_code ?? '' }}<br>{{ $partner_address->country ?? '' }}
                                            </div>
                                        </div>
                                        <div class="text-primary fs-5">
                                            <a style="cursor:pointer;" data-toggle="tooltip" title="Edit"
                                                data-bs-toggle="modal" data-bs-target="#addressUpdateModal"><i
                                                    class="fa-regular fa-pen-to-square"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex flex-row  justify-content-between">
                            ...
                            <div>
                                @if ($paymentmethod === null)
                                    <a href="add-payment-method/{{ $partner->id }}"><i data-toggle="tooltip"
                                            title="Associate a payment method" class="fa-solid fa-circle-plus"></i></a>
                                @endif
                            </div>
                        ...
                        @foreach ($users as $index => $user)
                            ...
                            <div class="d-flex flex-row justify-content-between w-100">
                                ...
                                <div class="col-lg-9">
                                    <div class="row">
                                        <div class="col-lg ms-3">
                                            <p class="p-0 m-0">
                                                <strong>{{ $user->first_name }}&nbsp;{{ $user->last_name }}@if ($user->is_primary)
                                                        <span>(Primary)</span>
                                                    @endif
                                                </strong>
                                            </p>
                                                ...
                                                <td data-label="Invitation Status">
                                                    <form action="{{ route('invite-again', [], false) }}" method="post">
                                                        ...
                                                        <input type="hidden" name="id"
                                                            value="{{ $partner->id }}">
                                                        <input type="hidden" name="zoho_cpid"
                                                            value="{{ $user->zoho_cpid }}">
                                                        <button type="submit"
                                                            class="btn btn-sm rounded button-clearlink text-primary fw-bold">Resend
                                                            Invite</button>
                                                    </form>
                                                </td>
                                            @endif
                                ...
                                <div class="col-lg mt-2 ms-5">
                                    <a style="cursor:pointer;" class="text-primary ms-3" data-toggle="tooltip"
                                        title="Edit" data-bs-toggle="modal"
                                        data-bs-target="#userUpdateModal{{ $user->zoho_cpid }}"><i
                                            class="fa-regular fa-pen-to-square"></i></a>
                                    @if ($user->status === 'active')
                                        <a href="disable-user/{{ $user->zoho_cpid }}" data-toggle="tooltip"
                                            title="Mark as Inactive" class="text-primary ms-3">

                                            <i class="fa-solid fa-user-slash"></i>
                                        </a>
                                    @else
                                        <a href="reactivate-user/{{ $user->zoho_cpid }}" data-toggle="tooltip"
                                            title="Mark as Active" class="text-primary ms-3">
                                            <i class="fa-solid fa-user"></i>
                                        </a>
                                    @endif
                                    @if (!$user->is_primary)
                                        <a href="mark-primary/{{ $user->zoho_cpid }}" data-toggle="tooltip"
                                            title="Mark as Primary" class="text-primary ms-3">
                            ...
                            <div class="modal fade" id="userUpdateModal{{ $user->zoho_cpid }}" tabindex="-1"
                                        ...
                                        <div class="modal-body">
                                            <form action="/update-user" method="post">
                                                ...
                                                <div>
                                                    <div class=" mb-3 row">
                                                        <div class="col-lg">
                                                            <input name="first_name" class="ms-2 form-control"
                                                                value="{{ $user->first_name }}" required
                                                                placeholder="First Name">
                                                        </div>
                                                        <div class="col-lg">
                                                            <input name="last_name" class="ms-2 form-control"
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-lg">
                                                        <input name="email" class="ms-2 form-control"
                                                            value="{{ $user->email }}" required placeholder="Email">
                                                    </div>
                                                    <div class="col-lg">
                                                        <input name="phone_number" class="ms-2 form-control"
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-lg-6">
                                                        <select type="text" name="role" class="form-select"
                                                            ...
                                                            <option value="user" id="business_user1">Business User
                                                            </option>
                                                            <option value="billing_contact" id="billing_contact1">
                                                                Billing Contact</option>
                                                        </select>
                                                    </div>
                                                    <p id="billing_message1" class="body-text-small mt-2 ms-1"></p>
                                                </div>
                                                <input type="text" value="{{ $user->zoho_cpid }}" name="zoho_cpid"
                                                    hidden />
                                                <input type="text" value="{{ $partner->zoho_cust_id }}"
                                                    name="zoho_cust_id" hidden />
                                                <input type="submit" class="btn btn-primary px-3 py-2 rounded"
                                                    value="Save Changes">
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <div class="modal fade" id="removeAffiliateModal" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content bg-popup">
                                        ...
                                        <div class="modal-body">
                                            <form action="/remove-affiliate" method="post">
                                                @csrf
                                                <div class=" row">
                                                    <label for="affiliate_id" class="form-label fw-bold">Select Affiliate
                                                        Ids*</label>
                                                    <div class="custom-dropdown-remove">
                                                        <div class="custom-dropdown-button-remove rounded">
                                                            <div class="tags-container-remove"><input type="hidden"
                                                                    id="hiddenSelect-remove" name="affiliate_ids[]" />
                                                            </div>
                                                            <i
                                                                class="fas fa-chevron-down dropdown-icon text-secondary"></i>
                                                        </div>
                                                        <div class="custom-dropdown-content-remove">
                                                            @foreach ($isp_affiliates as $affiliate)
                                                                <option class="custom-option-remove"
                                                ...
                                                <div class="modal-footer border-0 p-0 mt-3">
                                                    <input type="submit" class="btn btn-primary py-1 rounded "
                                                        value="Save">
                                                    <button type="button" id="cancel" onclick="reload()"
                                                ...
                                                <div class=" row">
                                                    ...
                                                    <div class="custom-dropdown">
                                                        <div class="custom-dropdown-button rounded">
                                                            <div class="tags-container"><input type="hidden"
                                                                    id="hiddenSelect" name="affiliate_ids[]" /></div>
                                                            <i
                                                                class="fas fa-chevron-down dropdown-icon text-secondary"></i>
                                                        </div>
    ...
    <div class="modal fade" id="partnerUpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content bg-popup">
                <div class=" modal-header">
                    ...
                    <form action="/update-partner" method="post">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg">
                                ...
                                <input name="advertiser_id" class=" form-control"
                                    value="{{ $partner->isp_advertiser_id }}" placeholder="Advertiser ID" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-lg">
                                <label for="tax_number" class="form-label fw-bold">EIN ID</label>
                                <input name="tax_number" class=" form-control" value="{{ $partner->tax_number }}"
                                    placeholder="EIN ID">
                            </div>
                            <div class="col-lg">
                                ...
                                <select name="payment_gateway" id="per_page" class="form-select" required>
                                    ...
                                    <option value="stripe" {{ $payment_gateway == 'stripe' ? 'selected' : '' }}>Stripe
                                    </option>
                                    <option value="forte" {{ $payment_gateway == 'forte' ? 'selected' : '' }}>Csg
                                        Forte(ACH)</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8 mb-3 ">
                                ...
                                <div id="tune-links-container1">
                                    ...
                                    @foreach ($links as $key => $link)
                                        <div class="link-field1 mb-2 d-flex flex-row">
                                            <input type="text" name="tune_link[{{ $key }}]"
                                                value="{{ $link }}" class="form-control mb-2 "
                                                placeholder="Tune Link">
                                            <button type="button"
                                                class="btn btn-danger btn-sm remove-link">Remove</button>
                                        </div>
                                    @endforeach
                                </div>

                                <button type="button" class="btn button-clearlink text-primary fw-bold mt-2"
                                    id="add-more-links1">Add More
                                    Links</button>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#add-more-links1').click(function() {
                const newInput = $('<div>', {
                    class: 'link-field1 mb-2 d-flex flex-row'
                }).append(
                    $('<input>', {
                        type: 'text',
                        name: 'tune_link[]',
                ...
                $('#tune-links-container1').append(newInput);
            });

            $('#tune-links-container1').on('click', '.remove-link', function() {
                $(this).closest('.link-field1').remove();
            });
        });
    </script>
